...
public class StringMethods {
    ...
    public static String compareEquality(String a, String b) {
        ...
        String equalsResult = a.equals(b) ? "true" : "false";
        String equalsIgnoreCaseResult = a.equalsIgnoreCase(b) ? "true" : "false";

        return "equals: " + equalsResult + ", equalsIgnoreCase: " + equalsIgnoreCaseResult;
    }
    ...
    public static String replaceDemo(String text, String oldWord, String newWord) {
        ...
        String swappedText = text.replace(oldWord, newWord);
        return swappedText.replaceAll("\\d", "#");
    }
