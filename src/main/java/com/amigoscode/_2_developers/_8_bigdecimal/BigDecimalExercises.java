...
public class BigDecimalExercises {
    ...
    public static void demonstrateDoubleProblem() {
        ...
        System.out.println("The problem is, when using Double, the Double object would want to use the precise value hence why the printing number is not exactly 0.1, and that is also why Big Decimal exists.");
    }
